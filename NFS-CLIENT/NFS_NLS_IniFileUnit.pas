          ...
          {$I-}
               ...
               Begin
                   ...
                   Begin
                          ...
                          IdentList[SectionList.Count-1].add( SpaceCut(Ident) );
...
Begin
    ...
    IF SectionIndex=-1 Then Begin Result:=FALSE;ErrorString:=FileSplit(IniFileName,2)+#13+'Section "['+Section+']" was not found';Exit;End
                       else
                 Begin
                      IdentIndex:=IdentList[SectionIndex].IndexOf(Ident);
                      IF IdentIndex=-1 Then
                      Begin
                           Result:=FALSE;ErrorString:='IDENT "'+Ident+'" was not found in Section : '+Section+#13+'INI Filename : '+INiFilename;exit;
                      End else
                      Begin
