{…ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕª
 ∫                                                                          ∫
 ∫     Utility Unit fÅr NFS Projekt                                         ∫
 ∫                                                                          ∫
 ∫     Version 1 am 19.06.2006 - zulÑst geÑnderd  17.07.2006                ∫
 ∫                                                                          ∫
...
VAR
   NFSFile:DataFile;
              ...
              Function SpaceCut(aString:String):String;
              // Schneided den öbergebenen String ab dem 1.lerrzeichen ab, und liefert ihn zurÅck;
              VAR Posi:Byte;
              Begin
                   Posi:=POS(' ',aString);
                   IF Posi=0 Then
...
Begin
      ...
      // 1. Schleife : feststellen welche Laufwerke vorhanden sind
        ...
        // 2.Schleife : Neue Laufwerke erstellen, vorhandene nicht Åbernehmen
        For T:=0 to 25 do
        Begin
                DriveCHar:=Chr(65+t);
...
Begin
     ...
     Z.B. Trace ist im Programm auf aus, in der INI aber auf An, Trace wÅrde trotzdem durchgefÅhrt werden
     }
...
Function FindInStringList(SearchStri:String;Items:TStrings):Longint;
// Sucht nach dem ersten eines Strings in einer Stringlist, RÅckgabe =-1 wenn nicht gefunden, ansonnsten die Position
...
Begin
    ...
    End;
    IF not DeleteFile(FileName) Then MyErrorBox('LOG Datei nicht lîschbar !');
End;
