...
{ 23.10.2006 - Backup.Ini wurde bei Alternativen sicherungspaf trotzdem ins Programm Backup Dir geschrieben
  ...
  24.10.2006 - Auswahl ob énderungen mit oder ohne neustart Åbernommen werden sollen wurde nicht angeziegt wenn die
              checkboxx "Alles Wiederherstellen" ausgewÑhlt wurde , da flag "interf" nicht auf TRUE gesetzt wurde.
  24.10.2006 - Information ausgeben wenn CONFIG.SYS wiederherstellung gewÅnscht wird, aber versucht wird Radio Button
               "énderungen ohne Systemstart zu Åbernehmen" ausgewÑhlt wurde.
  ...
  24.10.2006 BallonHint hinzugefÅgt.

  24.10.2006 Wiederherstellungs öbersicht zeige auch Dateien anstatt nur Verzeichnisse an.

             énderung in Procdure "DisplayRestoreOverview" Findfirst suche nur mit attribute fadirectory
             Ñnderung auf "directory shl 8 or anyfile"

  25.10.2006 énderungen der Eigenschaft "readonly" bei alternatoven Backup's/ restores von FALSE auf TRUE
