...
Implementation
Uses TCP_Var_Unit,DOs,Dialogs,Classes,MYMessageBox,{TCP_Options}Forms,TCP_NewIniFile,ustring,Sysutils;
...
case EntryField of
     EF_IPNUM   : Mess:=GetNlsString('MESSAGE','INVALID_IP_Address');
