...
USES TCP_LanguageUnit,MyMessageBox,Sysutils;
...
Begin
     ...
     ENd;
     MyErrorBox(GetNLSString('ERRORS',NLSIdent)+#13+GetNLSString('ERRORS','CPY_FILENAME')+Filename+GetNLSString('ERRORS','CPY_ERRORMESSAGE')+aString);
